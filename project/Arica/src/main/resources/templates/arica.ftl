	...
	<header id="header">
		<div>
			<a href="addtor" class="download1"> <span
            			...
            			</a> <a href="templates" class="about"> <span
            				class="glyphicon glyphicon-paperclip"></span> <br>模板管理
            			</a> <a href="https://mashibing.com/#" class="home"> </a> <a href="check"
            			...
            			</a> <a class="demo" href="health"> <span
            				class="glyphicon glyphicon glyphicon-tasks"></span> <br>系统状态
            			</a><a class="demo" href="main#"> <span
            				class="glyphicon glyphicon glyphicon-tasks"></span> <br>站点首页
            			</a>
		</div>
	</header>

	<div class="content why-hilo">
		<h2>Arica Ecosystem</h2>

		<p class="info">
			Arica是一个在分布式中，数据静态化方案。 <br/>

		</p>

		<div style="text-align: -webkit-center;">

			<img src="img/c.png" class="thumbnail" width="600px" />
		</div>
